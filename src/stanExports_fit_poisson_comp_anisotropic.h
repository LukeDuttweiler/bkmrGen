...
namespace model_fit_poisson_comp_anisotropic_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 47> locations_array__ =
  {" (found before start of program)",
  " (in 'fit_poisson_comp_anisotropic', line 13, column 2 to column 17)",
  " (in 'fit_poisson_comp_anisotropic', line 14, column 2 to column 23)",
  " (in 'fit_poisson_comp_anisotropic', line 15, column 2 to column 33)",
  " (in 'fit_poisson_comp_anisotropic', line 16, column 2 to column 17)",
  " (in 'fit_poisson_comp_anisotropic', line 17, column 2 to column 19)",
  " (in 'fit_poisson_comp_anisotropic', line 18, column 2 to column 20)",
  " (in 'fit_poisson_comp_anisotropic', line 26, column 2 to column 27)",
  " (in 'fit_poisson_comp_anisotropic', line 27, column 2 to column 27)",
  " (in 'fit_poisson_comp_anisotropic', line 32, column 2 to column 115)",
  " (in 'fit_poisson_comp_anisotropic', line 33, column 2 to column 37)",
  " (in 'fit_poisson_comp_anisotropic', line 29, column 4 to column 43)",
  " (in 'fit_poisson_comp_anisotropic', line 30, column 4 to column 21)",
  " (in 'fit_poisson_comp_anisotropic', line 28, column 15 to line 31, column 3)",
  " (in 'fit_poisson_comp_anisotropic', line 28, column 2 to line 31, column 3)",
  " (in 'fit_poisson_comp_anisotropic', line 36, column 2 to column 40)",
  " (in 'fit_poisson_comp_anisotropic', line 38, column 4 to column 26)",
  " (in 'fit_poisson_comp_anisotropic', line 37, column 15 to line 39, column 3)",
  " (in 'fit_poisson_comp_anisotropic', line 37, column 2 to line 39, column 3)",
  " (in 'fit_poisson_comp_anisotropic', line 41, column 4 to line 43, column 54)",
  " (in 'fit_poisson_comp_anisotropic', line 40, column 15 to line 44, column 3)",
  " (in 'fit_poisson_comp_anisotropic', line 40, column 2 to line 44, column 3)",
  " (in 'fit_poisson_comp_anisotropic', line 45, column 2 to column 24)",
  " (in 'fit_poisson_comp_anisotropic', line 46, column 2 to column 24)",
  " (in 'fit_poisson_comp_anisotropic', line 47, column 2 to column 25)",
  " (in 'fit_poisson_comp_anisotropic', line 48, column 2 to column 39)",
  " (in 'fit_poisson_comp_anisotropic', line 2, column 2 to column 17)",
  " (in 'fit_poisson_comp_anisotropic', line 3, column 2 to column 17)",
  " (in 'fit_poisson_comp_anisotropic', line 4, column 2 to column 17)",
  " (in 'fit_poisson_comp_anisotropic', line 5, column 9 to column 10)",
  " (in 'fit_poisson_comp_anisotropic', line 5, column 12 to column 13)",
  " (in 'fit_poisson_comp_anisotropic', line 5, column 2 to column 17)",
  " (in 'fit_poisson_comp_anisotropic', line 6, column 8 to column 9)",
  " (in 'fit_poisson_comp_anisotropic', line 6, column 18 to column 19)",
  " (in 'fit_poisson_comp_anisotropic', line 6, column 2 to column 23)",
  " (in 'fit_poisson_comp_anisotropic', line 7, column 8 to column 9)",
  " (in 'fit_poisson_comp_anisotropic', line 7, column 2 to column 11)",
  " (in 'fit_poisson_comp_anisotropic', line 8, column 2 to column 17)",
  " (in 'fit_poisson_comp_anisotropic', line 13, column 9 to column 10)",
  " (in 'fit_poisson_comp_anisotropic', line 15, column 30 to column 31)",
  " (in 'fit_poisson_comp_anisotropic', line 16, column 9 to column 10)",
  " (in 'fit_poisson_comp_anisotropic', line 17, column 10 to column 11)",
  " (in 'fit_poisson_comp_anisotropic', line 18, column 9 to column 10)",
  " (in 'fit_poisson_comp_anisotropic', line 26, column 8 to column 9)",
  " (in 'fit_poisson_comp_anisotropic', line 27, column 8 to column 9)",
  " (in 'fit_poisson_comp_anisotropic', line 32, column 9 to column 10)",
  " (in 'fit_poisson_comp_anisotropic', line 33, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_fit_poisson_comp_anisotropic final : public model_base_crtp<model_fit_poisson_comp_anisotropic> {
private:
  int N;
  int p;
  int d;
...
public:
  ~model_fit_poisson_comp_anisotropic() {}
  model_fit_poisson_comp_anisotropic(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_fit_poisson_comp_anisotropic_namespace::model_fit_poisson_comp_anisotropic";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = d + 1 + p + p + (p - 1) + N;
  }
  inline std::string model_name() const final {
    return "model_fit_poisson_comp_anisotropic";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_fit_poisson_comp_anisotropic_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      zeta = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(p);
      ...
      for (int i = 1; i <= p; ++i) {
        ...
        stan::model::assign(r, (stan::math::sqrt(2) *
          stan::math::exp(
            (stan::model::rvalue(theta, "theta", stan::model::index_uni(i)) *
            stan::model::rvalue(zeta, "zeta", stan::model::index_uni(i))))),
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_fit_poisson_comp_anisotropic_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "lambda", "delta", "zeta",
                "theta", "h_tilde"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"r", "l", "h_hat", "ystar"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(d) + "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"zeta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"h_tilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"r\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"l\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"h_hat\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"ystar\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(d) + "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"zeta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((p -1)) + "},\"block\":\"parameters\"},{\"name\":\"h_tilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"r\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"l\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"h_hat\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"ystar\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((d + 1) + p) + p) + p) + N);
    const size_t num_transformed = emit_transformed_parameters * ((((p + p) +
      N) + N));
...
using stan_model = model_fit_poisson_comp_anisotropic_namespace::model_fit_poisson_comp_anisotropic;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_fit_poisson_comp_anisotropic_namespace::profiles__;
}
#endif
#endif
