...
#include "stanExports_fit_poisson_anisotropic.h"

RCPP_MODULE(stan_fit4fit_poisson_anisotropic_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_fit_poisson_anisotropic")
