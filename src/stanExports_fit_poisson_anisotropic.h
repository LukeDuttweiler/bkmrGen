...
namespace model_fit_poisson_anisotropic_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 37> locations_array__ =
  {" (found before start of program)",
  " (in 'fit_poisson_anisotropic', line 13, column 2 to column 17)",
  " (in 'fit_poisson_anisotropic', line 14, column 2 to column 23)",
  " (in 'fit_poisson_anisotropic', line 15, column 2 to column 20)",
  " (in 'fit_poisson_anisotropic', line 16, column 2 to column 17)",
  " (in 'fit_poisson_anisotropic', line 17, column 2 to column 19)",
  " (in 'fit_poisson_anisotropic', line 25, column 2 to column 27)",
  " (in 'fit_poisson_anisotropic', line 29, column 2 to column 113)",
  " (in 'fit_poisson_anisotropic', line 30, column 2 to column 37)",
  " (in 'fit_poisson_anisotropic', line 27, column 4 to column 48)",
  " (in 'fit_poisson_anisotropic', line 26, column 15 to line 28, column 3)",
  " (in 'fit_poisson_anisotropic', line 26, column 2 to line 28, column 3)",
  " (in 'fit_poisson_anisotropic', line 33, column 2 to column 40)",
  " (in 'fit_poisson_anisotropic', line 34, column 2 to column 53)",
  " (in 'fit_poisson_anisotropic', line 35, column 2 to column 24)",
  " (in 'fit_poisson_anisotropic', line 36, column 2 to column 24)",
  " (in 'fit_poisson_anisotropic', line 37, column 2 to column 25)",
  " (in 'fit_poisson_anisotropic', line 38, column 2 to column 39)",
  " (in 'fit_poisson_anisotropic', line 2, column 2 to column 17)",
  " (in 'fit_poisson_anisotropic', line 3, column 2 to column 17)",
  " (in 'fit_poisson_anisotropic', line 4, column 2 to column 17)",
  " (in 'fit_poisson_anisotropic', line 5, column 9 to column 10)",
  " (in 'fit_poisson_anisotropic', line 5, column 12 to column 13)",
  " (in 'fit_poisson_anisotropic', line 5, column 2 to column 17)",
  " (in 'fit_poisson_anisotropic', line 6, column 8 to column 9)",
  " (in 'fit_poisson_anisotropic', line 6, column 18 to column 19)",
  " (in 'fit_poisson_anisotropic', line 6, column 2 to column 23)",
  " (in 'fit_poisson_anisotropic', line 7, column 8 to column 9)",
  " (in 'fit_poisson_anisotropic', line 7, column 2 to column 11)",
  " (in 'fit_poisson_anisotropic', line 8, column 2 to column 17)",
  " (in 'fit_poisson_anisotropic', line 13, column 9 to column 10)",
  " (in 'fit_poisson_anisotropic', line 15, column 9 to column 10)",
  " (in 'fit_poisson_anisotropic', line 16, column 9 to column 10)",
  " (in 'fit_poisson_anisotropic', line 17, column 10 to column 11)",
  " (in 'fit_poisson_anisotropic', line 25, column 8 to column 9)",
  " (in 'fit_poisson_anisotropic', line 29, column 9 to column 10)",
  " (in 'fit_poisson_anisotropic', line 30, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_fit_poisson_anisotropic final : public model_base_crtp<model_fit_poisson_anisotropic> {
private:
  int N;
  int p;
  int d;
...
public:
  ~model_fit_poisson_anisotropic() {}
  model_fit_poisson_anisotropic(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_fit_poisson_anisotropic_namespace::model_fit_poisson_anisotropic";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = d + 1 + N + p + (p - 1);
  }
  inline std::string model_name() const final {
    return "model_fit_poisson_anisotropic";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_fit_poisson_anisotropic_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      for (int i = 1; i <= p; ++i) {
        ...
        stan::model::assign(l,
          stan::math::inv((stan::math::sqrt(2) *
            stan::math::exp(
      ...
      stan::math::check_greater_or_equal(function__, "l", l, 0);
      {
        ...
        lp_accum__.add(stan::math::dirichlet_lpdf<propto__>(theta,
                         stan::math::rep_vector(1.0, p)));
        current_statement__ = 13;
        lp_accum__.add((stan::math::gamma_lpdf<false>(stan::math::exp(zeta),
                          1, 1) + stan::math::sum(zeta)));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_fit_poisson_anisotropic_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "lambda", "h_tilde", "zeta",
                "theta"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(d) + "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"h_tilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"zeta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"l\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"h_hat\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"ystar\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(d) + "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"h_tilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"zeta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((p -1)) + "},\"block\":\"parameters\"},{\"name\":\"l\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(p) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"h_hat\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"ystar\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_fit_poisson_anisotropic_namespace::model_fit_poisson_anisotropic;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_fit_poisson_anisotropic_namespace::profiles__;
}
#endif
#endif
