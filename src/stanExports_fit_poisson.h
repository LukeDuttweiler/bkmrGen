...
static constexpr std::array<const char*, 34> locations_array__ =
  ...
  " (in 'fit_poisson', line 14, column 2 to column 22)",
  " (in 'fit_poisson', line 15, column 2 to column 20)",
  " (in 'fit_poisson', line 18, column 2 to column 49)",
  " (in 'fit_poisson', line 19, column 2 to column 47)",
  " (in 'fit_poisson', line 20, column 2 to column 32)",
  " (in 'fit_poisson', line 21, column 2 to column 31)",
  " (in 'fit_poisson', line 22, column 2 to column 35)",
  " (in 'fit_poisson', line 25, column 2 to column 22)",
  " (in 'fit_poisson', line 26, column 2 to column 23)",
  " (in 'fit_poisson', line 27, column 2 to column 25)",
  " (in 'fit_poisson', line 28, column 2 to column 18)",
  ...
  " (in 'fit_poisson', line 18, column 9 to column 10)",
  " (in 'fit_poisson', line 18, column 12 to column 13)",
  " (in 'fit_poisson', line 19, column 9 to column 10)",
  " (in 'fit_poisson', line 19, column 12 to column 13)",
  " (in 'fit_poisson', line 20, column 9 to column 10)",
  " (in 'fit_poisson', line 21, column 9 to column 10)",
  " (in 'fit_poisson', line 22, column 18 to column 19)"};
...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      stan::model::assign(mu, stan::math::exp(eta), "assigning variable mu");
      current_statement__ = 8;
      stan::math::check_greater_or_equal(function__, "mu", mu, 0);
      {
        ...
        lp_accum__.add(stan::math::poisson_lpmf<propto__>(y, mu));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"cov", "L_cov", "f", "eta", "mu"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(d) + "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"f_tilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"cov\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"L_cov\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"f\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"}]");
  }
